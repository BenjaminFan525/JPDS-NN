...
log_paths = [
        "/home/fanyx/mdvrp/experiment/log_t_6.txt",
        # "/home/fanyx/mdvrp/result/training_rl/ppo/2025-02-10__14-06/log.txt",
        "/home/fanyx/mdvrp/experiment/log_t_7.txt",
...
output_path = os.path.join(*log_path.split(os.path.sep)[:-1], 'diatance_pt.png')
...
output_path = os.path.join(*log_path.split(os.path.sep)[:-1], 'time_pt.png')
if log_path[0] == os.path.sep:
    output_path = os.path.sep + output_path
plt.savefig(output_path)
...
output_path = os.path.join(*log_path.split(os.path.sep)[:-1], 'oil_pt.png')
if log_path[0] == os.path.sep:
    output_path = os.path.sep + output_path
plt.savefig(output_path)
