...
if __name__ == '__main__':
    ...
    def task(idx):
        ...
        stc = simulate(dataloaders[idx], ac, save_dir, model_type='mdvrp', stop_coeff=args.stop_coeff, render=args.render, fig_interval=args.fig_interval, pid=idx)
        ...
        stc = simulate(dataloaders[idx], ac_ia, save_dir, model_type='ia', stop_coeff=args.stop_coeff, render=args.render, fig_interval=args.fig_interval, pid=idx)
