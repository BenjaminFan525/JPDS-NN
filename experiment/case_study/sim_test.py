...
data = "/home/fanyx/mdvrp/data/Gdataset/Task_test_debug/6_2/3_26_24"
...
print(f"Simulator initializng...")
simulator.car_cfg = car_cfg
simulator.field = field
simulator.init_simulation(T)
# simulator.simulator.car_list = [simulator.simulator.car_list[0], simulator.simulator.car_list[0]]
